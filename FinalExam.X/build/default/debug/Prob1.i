...
# 66 "Prob1.c" 2
# 80 "Prob1.c"
int per_arrp[30] = { 784, 659, 659, 0, 698, 587, 587, 0, 523, 587, 659, 698, 784, 784, 784, 0,
784, 659, 659, 0, 698, 587, 587, 0, 523, 659, 784, 784, 659, 0
};
int TOTAL = 30;
...
void main(void)
{
    ...
    while(1) {
        ...
        if(strstr(mystring, "breath") != ((void*)0))
            ModeBreath();
        if(strstr(mystring, "blink 1 1") != ((void*)0))
        {
            max_count = 1;
            num_led = 1;
            ModeBlink();
        }
        if(strstr(mystring, "blink 2 1") != ((void*)0))
        {
            max_count = 1;
            num_led = 2;
            ModeBlink();
        }
        if(strstr(mystring, "blink 3 1") != ((void*)0))
        {
            max_count = 1;
            num_led = 3;
            ModeBlink();
        }
        if(strstr(mystring, "blink 4 1") != ((void*)0))
        {
            max_count = 1;
            num_led = 4;
            ModeBlink();
        }
        if(strstr(mystring, "blink 1 2") != ((void*)0))
        {
            max_count = 2;
            num_led = 1;
            ModeBlink();
        }
        if(strstr(mystring, "blink 2 2") != ((void*)0))
        {
            max_count = 2;
            num_led = 2;
            ModeBlink();
        }
        if(strstr(mystring, "blink 3 2") != ((void*)0))
        {
            max_count = 2;
            num_led = 3;
            ModeBlink();
        }
        if(strstr(mystring, "blink 4 2") != ((void*)0))
        {
            max_count = 2;
            num_led = 4;
            ModeBlink();
        }
        if(strstr(mystring, "music 1") != ((void*)0))
        {
            init_arr1();
            ModeMusic();
        }
        if(strstr(mystring, "music 2") != ((void*)0))
        {
            init_arr2();
            ModeMusic();
        }
        if(strstr(mystring, "p") != ((void*)0))
            ModeMusic();
