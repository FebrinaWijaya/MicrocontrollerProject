 ...
 * Author: febri
 *
 * Created on December 19, 2018, 8:48 PM
 */
// CONFIG1H
...
void adc_init(void){
    ...
    ADCON2bits.ACQT = 5; //setting acquisition time ACQT<2:0> 2Tad = 2.4 us (Tacqt should be >=2.4us)
    ADCON2bits.ADCS = 4; //conversion time Frc (Tad = 1.2 us) //because fosc = 1MHz
